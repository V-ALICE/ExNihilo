...
namespace ExNihilo.UI.Bases
{
    public abstract class UILibrary
    {
        ...
        {
            TextureLookUp = new Dictionary<string, Texture2D> {{"null", new Texture2D(graphics, 1, 1)}};
            ...
            foreach (var file in infoFiles)
            {
                ...
                for (int i = 1; i < lines.Length; i++)
                {
                    ...
                    TextureLookUp.Add(name, TextureUtilities.GetSubTexture(graphics, sheet, new Rectangle(x, y, width, height)));
                }
