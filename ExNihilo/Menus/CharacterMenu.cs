...
********************************************************************/
        ...
        public CharacterMenu(GameContainer container) : base(container)
        {
            ...
            var backButton = new UIClickable("BackButton", "UI/button/SmallButton", new Coordinate(10, -10), ColorScale.White, _panelUI, TextureUtilities.PositionType.BottomLeft, TextureUtilities.PositionType.BottomLeft);
            ...
            _panelUI.AddElements(backButton, backButtonText);
        }
